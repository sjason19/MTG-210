...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        ArrayList<ArrivalBoard> listArrivalBoards = new ArrayList<>();
        Iterator iterator = StationManager.getInstance().getSelected().iterator();

        while (iterator.hasNext()) {
            ArrivalBoard ab = (ArrivalBoard) iterator.next();
            listArrivalBoards.add(ab);
        }
        return listArrivalBoards;
    }
